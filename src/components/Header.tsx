        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h1 className="text-[17px] sm:text-lg font-serif font-bold text-[#1b3d27] leading-tight truncate tracking-tight">
            ...
            <div className="hidden sm:flex items-center gap-2 text-[11px] text-[#556358] font-medium mt-0.5">
              <span>{t('AI-Powered Healthcare Intake')}</span>
              <span className="w-1 h-1 rounded-full bg-[#829277]" />
              <span className="text-[#6f4827]">{t('Clinical Review Required')}</span>
            </div>
          </div>
        </div>
